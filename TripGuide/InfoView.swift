...
struct InfoView: View {
    ...
    var body: some View {
        List {
            Section {
                infoRow("Сразу", "Отель Лондон (8 ночей), апартаменты Ле-Зарк 1950 — в Ле-Зарке мало вариантов жилья на пике сезона.")
                infoRow("Сразу", "Евростар Лондон → Париж (13.09) — цены растут по мере заполнения поезда.")
                infoRow("Сразу", "Авиабилеты Москва → Лондон (05.09) и Лион → Москва (26.09) — единым билетом через Стамбул, Turkish Airlines.")
                ...
                infoRow("За 4–6 недель", "Отели: Бон, Анси, Шамони, Турин.")
                infoRow("За 2–4 недели", "Aiguille du Midi (слот на 19.09, утро).")
                infoRow("За 2–4 недели", "Турин: Museo Egizio и Музей кино в Моле — слоты на 25.09.")
                infoRow("За 2 недели", "Рестораны с бронью: Caves Madeleine, La Cabane des Praz, Consorzio (Турин).")
            ...
            Section {
                ...
                Text("Мед. страховка на все 22 дня, с покрытием горных активностей.")
            ...
            Section {
                ...
                weatherRow("Турин", "+20…+26°C днём", "По-южному тепло")
            } header: {
                sectionHeader("Погода в сентябре", icon: "cloud.sun.fill")
            }

            Section {
                Text("eSIM с пакетом на Европу вкл. Великобританию на все 22 дня.")
            ...
            Section {
                ...
                budgetRow("Еда", "€2190–3500", "22 дня")
                ...
                budgetRow("Билеты и активности", "€1045–1341", "музеи, аттракционы, аутлет")
                HStack {
            ...
            Section {
                Text("Самый длинный день — Ле-Зарк → Серравалле → Турин (~400 км с шопингом): ранний выезд, меняйтесь за рулём.")
                Text("Перевал Col du Petit-Saint-Bernard закрыт: в Италию через тоннель Фрежюс (из Модана) или Мон-Блан.")
                ...
                Text("Несдвигаемые точки: Harry Potter, Farmer's Dog, Disney, музеи Турина, авиабилеты. Остальное — гибко.")
            } header: {
