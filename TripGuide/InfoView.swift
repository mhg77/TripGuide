    ...
    var body: some View {
        List {
            Section {
                ...
                infoRow("За 2–4 недели", "QC Terme (24.09 вечер + 25.09 день).")
            ...
            Section {
                Text("Самый длинный день — радиалка Ле-Зарк ⇄ Серравалле (~302 км в одну сторону): выезд не позже 7:00, меняйтесь за рулём. Если нет настроения — просто останьтесь в деревне.")
