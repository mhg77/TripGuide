...
enum RouteData {
    static let allRoutes: [RouteLeg] = [
        ...
        RouteLeg(
            id: 6, dateLabel: "24.09", title: "Ле-Зарк → Курмайёр → Серравалле → Турин", mode: .car,
            distance: "~410 км суммарно", duration: "~6 ч за рулём + Skyway и аутлет",
            roadNote: "Через перевал Col du Petit-Saint-Bernard в Курмайёр (Skyway Monte Bianco), дальше на юг к аутлету Серравалле и ~1 ч 10 мин на север в Турин.",
            warning: "Очень длинный день: Монблан утром, шопинг днём и ~6 часов за рулём. Ранний выезд обязателен; при закрытии перевала — тоннель Фрежюс из Модана.",
            ...
            waypoints: [
                ...
                RouteWaypoint(name: "Skyway Monte Bianco (Курмайёр)", lat: 45.7963, lon: 6.9645),
